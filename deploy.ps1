...
Write-Host "`n✅ Done! Check your Netlify dashboard at https://app.netlify.com/sites/mekathvision/overview" -ForegroundColor Green
Write-Host "The site will be live at: https://mekathvision.netlify.app" -ForegroundColor Cyan
pause
