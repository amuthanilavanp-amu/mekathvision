...
function setupEventListeners() {
    ...
    document.getElementById('gate-form')?.addEventListener('submit', handleLogin);
...
async function handleLogin(e) {
    e.preventDefault();
    const email = document.getElementById('login-email')?.value || document.getElementById('gate-name')?.value;
    const password = document.getElementById('login-password')?.value || document.getElementById('gate-passcode')?.value;
    
    if (!email || !password) return showAuthMessage('Please enter both name and passcode', 'error');
